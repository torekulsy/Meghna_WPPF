...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class EmployeeBreakMonthPFController : Controller
    {
        ...
        //D:\HRM\ShampanHRM\SymWebNew\Areas\BWWF\Controllers\EmployeeBreakMonthPFController.cs
        // GET: /BWWF/EmployeeBreakMonthPF/
        ...
        public ActionResult Create(EmployeeInfoVM empVM)
        {
            ...
            try
            {
                ...
                ////return Redirect("/BWWF/EmployeeBreakMonthPF/SingleEmployeeBreakMonthPFEdit?PFOpeinigId=" + result[2].ToString());
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ReportHead = "BWWF Employee BreakMonth Transactions";
                }
                dt.TableName = "dtEmployeeForfeiture";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptPFEmployeeBreakMonth.rpt";
