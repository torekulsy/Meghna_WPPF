...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class PFBankDepositController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/BWWF/Views/PFBankDeposit/Index.cshtml");
        }
        ...
        /// </summary>      
        /// <returns>View containing BWWF Bank Deposit</returns>
        ...
        public ActionResult Create(PFBankDepositVM vm)////string tType = "")
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/BWWF/Views/PFBankDeposit/Create.cshtml",vm);
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/BWWF/Views/PFBankDeposit/Report.cshtml");
        }
        ...
        public ActionResult ReportView(int id)
        {
            ...
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptBankDeposit.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFBankDeposit/reportVeiw.cshtml", vm);
