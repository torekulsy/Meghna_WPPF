...
using System.IO;
using System.Data;
using SymReporting.BWWF;
using OfficeOpenXml;
using OfficeOpenXml.Style;
using SymWebUI.Areas.BWWF.Models;
using Newtonsoft.Json;
using System.Collections.Generic;

namespace SymWebUI.Areas.BWWF.Controllers
{
    public class PFReportController : Controller
    {
        ...
        {
            return View("~/Areas/BWWF/Views/PFReport/Index.cshtml");
        ...
        /// </summary>
        /// <returns>
        /// Returns the view for the BWWF Bank Statement Report after verifying user permissions.
        /// </returns>
        ...
        public ActionResult PFBankStatementReport()
        {
            ...
            return View("~/Areas/BWWF/Views/PFReport/PFBankStatementReport.cshtml");
        ...
        /// <returns>Returns a PDF file containing the BWWF Bank Statement report.</returns>
        ...
        public ActionResult PFBankStatementReportView(string dtFrom = "", string dtTo = "", string bankBranchId = "")
        {
            try
            {
                ...
                ReportHead = "There are no data to Preview for BWWF Bank Statement";
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptPFBankStatement.rpt";
        ...
        public ActionResult AccountStatement()
        {
            ...
            return View("~/Areas/BWWF/Views/PFReport/AccountStatement.cshtml");
        ...
        {
            Session["permission"] = _repoSUR.SymRoleSession(identity.UserId, "10003", "add").ToString();
            return View("~/Areas/BWWF/Views/PFReport/PFInvestmentReport.cshtml");
        ...
        {
            Session["permission"] = _repoSUR.SymRoleSession(identity.UserId, "10003", "add").ToString();
            return View("~/Areas/BWWF/Views/PFReport/EmployeePFStatement.cshtml");
        ...
        {
            Session["permission"] = _repoSUR.SymRoleSession(identity.UserId, "10003", "add").ToString();
            return View("~/Areas/BWWF/Views/PFReport/EmployeePFSettlementReport.cshtml");
        ...
        {
            Session["permission"] = _repoSUR.SymRoleSession(identity.UserId, "10003", "add").ToString();
            return View("~/Areas/BWWF/Views/PFReport/EmployeeLoanSettelment.cshtml");
        ...
        {
            Session["permission"] = _repoSUR.SymRoleSession(identity.UserId, "10003", "add").ToString();
            return View("~/Areas/BWWF/Views/PFReport/EmployeeLoanClosed.cshtml");
        ...
        public ActionResult BankChargeReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/BankChargeReportVeiw.cshtml", vm);
        ...
        public ActionResult EmployeeBreakMonthPFReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/EmployeeBreakMonthPFReportVeiw.cshtml", vm);
        ...
        public ActionResult EmployeePFPaymentReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/EmployeePFPaymentReportVeiw.cshtml", vm);
        ...
        public ActionResult EmployeeForfeitureReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/EmployeeForfeitureReportVeiw.cshtml", vm);
        ...
        public ActionResult EmployeePFOpeinigReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/EmployeePFOpeinigReportVeiw.cshtml", vm);
        ...
        public ActionResult EmployeeReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/EmployeeReportVeiw.cshtml", vm);
        ...
        public ActionResult EmployeeLedgerReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/EmployeeLedgerReportVeiw.cshtml", vm);
        ...
        public ActionResult LoanReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/LoanReportVeiw.cshtml", vm);
        ...
        public ActionResult LoanMonthlyPaymentReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/LoanMonthlyPaymentReportVeiw.cshtml", vm);
        ...
        public ActionResult LoanRepaymentToBankReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/LoanRepaymentToBankReportVeiw.cshtml", vm);
        ...
        public ActionResult LoanSattlementReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/LoanSattlementReportVeiw.cshtml", vm);
        ...
        public ActionResult PFBankDepositsReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/PFBankDepositsReportVeiw.cshtml", vm);
        ...
        public ActionResult PFContributionReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/PFContributionReportVeiw.cshtml", vm);
        ...
        public ActionResult ProfitDistributionNewReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/ProfitDistributionNewReportVeiw.cshtml", vm);
        ...
        public ActionResult ReturnOnBankInterestsReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/ReturnOnBankInterestsReportVeiw.cshtml", vm);
        ...
        public ActionResult WithdrawsReportVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/WithdrawsReportVeiw.cshtml", vm);
        ...
        public ActionResult Voucher_StatementReportVeiw(string JournalType="1")
        {
            try
            {
                ...
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/Voucher_StatementReportVeiw.cshtml", vm);
        ...
        public ActionResult BankCharge_Statement(PFReportVM vm)
        {
            try
            {
                ...
                #endregion
                return Redirect("BWWF/PFDetail/IndexFiscalPeriod");
                #endregion
        ...
        public ActionResult EmployeePFOpeinig_Statement(PFReportVM vm)
        {
            try
            {
                ...
                string filename = "Employee BWWF Opening Statement " + "-" + DateTime.Now.ToString("yyyy-MM-dd-HHmmss");
                ExcelPackage excel = new ExcelPackage();
                ...
                string[] ReportHeaders = new string[] { "Employee BWWF Opening Statement", Line1, Line2, "Branch: " + branchName };
        ...
        public ActionResult EmployeeStatement(PFReportVM vm)
        {
            try
            {
                ...
                else
                {
                    ...
                    rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptEmployeeStatementDetails.rpt";
        ...
        public ActionResult EmployeeLedger(PFReportVM vm)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\RptPFIndividualLedger.rpt";
                    }
                    else
                    {
                        rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptPFEmployeeLedger.rpt";
                    }
                    CompanyRepo _CompanyRepo = new CompanyRepo();
                    CompanyVM cvm = _CompanyRepo.SelectAll().FirstOrDefault();
        ...
        public ActionResult TrialBalanceVeiw()
        {
            try
            {
                ...
                PFReportVM vm = new PFReportVM();
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PFReport/TrialBalanceVeiw.cshtml", vm);
         ...
         public ActionResult TrialBalanceReport(PFReportVM vm)
         {
             ...
             try
             {
                ...
                vm.TransType = "BWWF";
                 ...
                 rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptTrialBalance.rpt";
         ...
         public ActionResult IncomeStatementVeiw()
         {
             try
             {
                 ...
                 PFReportVM vm = new PFReportVM();
                 vm.TransType = AreaTypePFVM.TransType;
                 return PartialView("~/Areas/BWWF/Views/PFReport/IncomeStatementVeiw.cshtml", vm);
         ...
         public ActionResult IncomeStatementReport(PFReportVM vm)
         {
              ...
              try
             {
                 ...
                 rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptIncomeStatement.rpt";
         ...
         public ActionResult IFRSReportView(string ReportType)
         {
             try
             {
                 ...
                 vm.TransType = AreaTypePFVM.TransType;
                 return View(vm);
                 //return PartialView("~/Areas/BWWF/Views/PFReport/IFRSReporView.cshtml", vm);
             }
             catch (Exception)
             {
                 throw;
         ...
         public ActionResult IFRSReport(PFReportVM vm)
         {
             ...
             try
             {
                 ...
                 rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\" + fileName;
         ...
         public ActionResult BalanceSheetVeiw()
         {
             try
             {
                 ...
                 PFReportVM vm = new PFReportVM();
                 vm.TransType = AreaTypePFVM.TransType;
                 return PartialView("~/Areas/BWWF/Views/PFReport/BalanceSheetVeiw.cshtml", vm);
         ...
         public ActionResult BalanceSheetReport(PFReportVM vm)
         {
             ...
             try
             {
                 ...
                 dt.TableName = "dtFinancialReport";
                 rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptBalanceSheet.rpt";
         ...
         public ActionResult LedgerVeiw()
         {
             try
             {
                 ...
                 PFReportVM vm = new PFReportVM();
                 vm.TransType = AreaTypePFVM.TransType;
                 return PartialView("~/Areas/BWWF/Views/PFReport/LedgerVeiw.cshtml", vm);
             }
             catch (Exception)
             {
                 throw;
         ...
         /// <summary>
         /// Generates and returns a PDF report for the BWWF Ledger, including net change data within a specified date range.
         /// </summary>
         /// <param name="vm">The PFReportVM view model containing filtering parameters like DateFrom, DateTo, and others.</param>
         /// <returns>Returns a PDF file containing the BWWF Ledger report.</returns>
         /// <exception cref="Exception">Throws any exceptions that occur during report generation.</exception>
         [HttpPost]
         public ActionResult LedgerReport(PFReportVM vm)
         {
             ...
             try
             {
                 ...
                 {
                     rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptLedgerMultiple.rpt";
                 }
                 else
                 {
                     rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptLedger.rpt";
                 }                 
         ...
         public ActionResult AllEmployeeReportVeiw()
         {
             try
             {
                 ...
                 PFReportVM vm = new PFReportVM();
                 vm.TransType = AreaTypePFVM.TransType;
                 return PartialView("~/Areas/BWWF/Views/PFReport/AllEmployeeReportVeiw.cshtml", vm);
         ...
         public ActionResult AllEmployee(PFReportVM vm)
         {
             try
             {
                ...
                {
                    rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptEmployeeImageInfo.rpt";
                }
                else
                {
                    rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptIndividualEmployeeImageInfo.rpt";
                }
