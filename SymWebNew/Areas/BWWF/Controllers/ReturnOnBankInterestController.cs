...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class ReturnOnBankInterestController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/BWWF/Views/ReturnOnBankInterest/Index.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/BWWF/Views/ReturnOnBankInterest/Create.cshtml",vm);
        }
        [Authorize(Roles = "Admin")]
        [HttpPost]
        ...
        public ActionResult Detail(string id)
        {
            ...
            vm.TransType = AreaTypePFVM.TransType;
            vm = _repo.SelectAll(Convert.ToInt32(id)).FirstOrDefault();
            return View("~/Areas/BWWF/Views/ReturnOnBankInterest/Detail.cshtml", vm);
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/BWWF/Views/ReturnOnBankInterest/Report.cshtml");
        ...
        //        rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptReturnOnBankInterest.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                return PartialView("~/Areas/BWWF/Views/ReturnOnBankInterest/reportVeiw.cshtml", vm);
