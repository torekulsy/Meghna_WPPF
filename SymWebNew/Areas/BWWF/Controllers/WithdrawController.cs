...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class WithdrawController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/BWWF/Views/Withdraw/Index.cshtml");
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/BWWF/Views/Withdraw/Create.cshtml",vm);
        }
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/BWWF/Views/Withdraw/Report.cshtml");
        }
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                return PartialView("~/Areas/BWWF/Views/Withdraw/reportVeiw.cshtml", vm);
