...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class LoanController1 : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/BWWF/Views/Loan/Index.cshtml",vm);
        }
        ...
        public ActionResult Create()
        {
            ...
            return View("~/Areas/BWWF/Views/Loan/Create.cshtml" ,vm);
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptLoan.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.Code = Loanvm.Code;
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView( "~/Areas/BWWF/Views/Loan/reportVeiw.cshtml", vm);
            }
            catch (Exception)
            {
                throw;
