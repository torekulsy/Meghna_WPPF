...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class PFDetailController : Controller
    {
        ...
        /// Retrieves Fiscal Period Header data (Id, FiscalYearId) and processes BWWF details for the specified Fiscal Period.
        /// </summary>
        ...
        public ActionResult _indexFiscalPeriod(JQueryDataTableParamModel param, string EmployeeId = "", string fydid = "")
        {
            ...
            if (!string.IsNullOrEmpty(param.sSearch))
            {
                ...
                filteredData = getAllData
                    .Where(c =>
                       ...
                       || isSearchable4 && c.BWWFValue.ToString().ToLower().Contains(param.sSearch.ToLower())
            ...
            Func<PFHeaderVM, string> orderingFunction = (c =>
                ...
                sortColumnIndex == 4 && isSortable_4 ? c.BWWFValue.ToString() :
        ...
        /// Created: 10 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Handles the processing of BWWF details by interacting with the PFDetailRepo.
        /// </summary>
        ...
        /// Created: 10 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Handles the posting of BWWF Header data, retrieves permission, and returns the result in JSON format.
        /// </summary>
        /// <param name="ids">A string containing the IDs used to fetch BWWF Header details</param>
        /// <returns>JSON result with the status message from the post operation</returns>
        public JsonResult Post(string ids)
        {
            try
            {
                // Fetch user permission for editing the BWWF Header based on role and permissions
        ...
        /// Created: 10 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Generates and returns a Crystal Report PDF for BWWF Detail, filtered by the provided criteria.
        /// </summary>
        ...
        /// <returns>PDF file containing the BWWF Detail report</returns>
        public ActionResult ReportView(string fydid = "", string empCodeFrom = "", string empCodeTo = "", string groupBy = "")
        {
            try
            {
                // Initialize report variables
                string reportHead = "There are no data to Preview for BWWF Detail";
                string rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptPFDetail.rpt";
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("An error occurred while generating the BWWF Detail report.", ex);
            }
        }
        ...
        /// Created: 10 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Generates and returns a Crystal Report PDF detailing BWWF Contributions (Bank Deposit GL Transactions) 
        /// for a specific BWWF Header ID. Fetches employee-specific data and renders the report.
        /// </summary>
        /// <param name="id">PFHeaderId used to filter the contribution data for specific BWWF Header</param>
        /// <returns>PDF file containing the BWWF contribution details</returns>
        public ActionResult PFContributionDetailsReport(int id)
        {
            try
            {
                ...
                string rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptPFContributionDetails.rpt";
                ReportDocument doc = new ReportDocument();
                DataTable dt;
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("An error occurred while generating the BWWF Contribution Details Report.", ex);
            }
        }
        ...
        /// Created: 10 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Generates and returns a Crystal Report PDF summarizing BWWF Employer Provisions (Bank Deposit GL Transactions).
        ...
        /// <returns>PDF file containing the employer BWWF contribution summary</returns>
        ...
        public ActionResult PFContributionSummarysReport(int id)
        {
            try
            {
                ...
                string reportHead = "There are no data to Preview for GL Transaction for Bank Deposit";
                string rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\PFEmployeeContributionSummary.rpt";
                ReportDocument doc = new ReportDocument();
                DataTable dt;
        ...
        ///  Created: 01 Mar 2025 
        /// Created By : Md Torekul Islam
        /// Downloads the BWWF (Provident Fund) employee contribution details as an Excel file
        ...
        /// <returns>Redirects to the BWWF detail index after Excel download.</returns>
        [HttpGet]  ///Here's a version that mentions the method type more clearly.
        public ActionResult PFContributionDetailsDownload(int id)
        {
            try
            {
                ...
                // Define filter conditions to retrieve BWWF contribution details
                string[] conditionFields = { "pfd.PFHeaderId", "ve.BranchId" };
                string[] conditionValues = { id.ToString(), Session["BranchId"].ToString() };
                ...
                string StatementName = "BWWF Employee Contribution Details";
                ...
                return Redirect("BWWF/PFDetail/index");
        ...
        /// Created: 10 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Downloads the BWWF (Provident Fund) summary report as an Excel file  
        ...
        /// <param name="rType">The report type to determine the format or view of the BWWF summary.</param>
        /// <param name="ProjectId">The project identifier to filter BWWF summary data (overridden by parsed fydid).</param>
        /// <returns>Redirects to the BWWF detail fiscal period index after Excel file is downloaded.</returns>
        [HttpGet]
        public ActionResult PFReportSummaryDetail(string fydid, string rType, string ProjectId)
        {
            try
            {
                ...
                // Retrieve the BWWF summary report data based on parameters
                vm = report.PFReportSummaryDetail(fydid, rType, ProjectId);

                #region Excel Generation

                string filename = "BWWF Contribution " + rType;

                // Create a new Excel package and worksheet using EPPlus
                ExcelPackage excel = new ExcelPackage();
                var workSheet = excel.Workbook.Worksheets.Add("BWWF Contribution " + rType);
        ...
        /// <returns>PDF file containing the BWWF Contribution report.</returns>
        public ActionResult PFContributionReport(PFReportVM vm)
        {
            try
            {
                ...
                string rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptPFContribution.rpt";
                ReportDocument doc = new ReportDocument();
                DataTable dt;
        ...
        /// Created: 10 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Downloads Provident Fund (BWWF) details as an Excel file based on filtering parameters  
        ...
        public ActionResult DownloadPFDetailsExcel(string ProjectId, string DepartmentId, string SectionId, string DesignationId, string CodeF, string CodeT, int fid = 0, int ETId = 0, string Orderby = null)
        {
            ...
            try
            {
                ...
                // Fetch BWWF contribution data from repository
                ...
                string filename = "BWWF of" + "-" + dt.Rows[0]["Fiscal Period"].ToString();
        ...
        /// Created: 10 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Imports Provident Fund (BWWF) detail data from an uploaded Excel file and inserts it into the system.
        /// Validates user permission, saves the file to server, and processes it through repository logic.
        /// </summary>
        /// <param name="file">The uploaded Excel file containing BWWF details.</param>
        /// <param name="FYDId">Fiscal Year Detail ID.</param>
        ...
        public ActionResult InsertAutoJournal(string TransactionMonth, string TransactionForm, string TransactionCode)
        {
            ...
            return View("~/Areas/BWWF/Views/PFDetail/IndexFiscalPeriod.cshtml");
        }
