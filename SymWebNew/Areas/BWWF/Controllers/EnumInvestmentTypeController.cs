...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class EnumInvestmentTypeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/BWWF/Views/EnumInvestmentType/Index.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return PartialView("~/Areas/BWWF/Views/EnumInvestmentType/Create.cshtml", vm);
        }
