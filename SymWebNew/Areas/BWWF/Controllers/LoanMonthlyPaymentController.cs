...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class LoanMonthlyPaymentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/BWWF/Views/LoanMonthlyPayment/Index.cshtml",vm);
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/BWWF/Views/LoanMonthlyPayment/Create.cshtml", vm);
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                dt.TableName = "dtLoan";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptLoanMonthlyPayment.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/LoanMonthlyPayment/reportVeiw.cshtml", vm);
