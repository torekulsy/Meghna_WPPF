...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class PreDistributionFundController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/BWWF/Views/PreDistributionFund/Index.cshtml");
        ...
        public ActionResult Create()
        {
            ...
            return View("~/Areas/BWWF/Views/PreDistributionFund/Create.cshtml",vm);
        }
        ...
        public ActionResult IndexReturnOnInvestment(string tType)
        {
            ...
            return View("~/Areas/BWWF/Views/PreDistributionFund/IndexReturnOnInvestment.cshtml",vm);
        ...
        public ActionResult IndexReturnOnBankInterest(string tType)
        {
            ...
            vm.TransType = AreaTypePFVM.TransType;
            vm.TransactionType = tType;
            return View("~/Areas/BWWF/Views/PreDistributionFund/IndexReturnOnBankInterest.cshtml",vm);
        ...
        public ActionResult IndexForfeitureAccount(string tType)
        {
            ...
            vm.TransType = AreaTypePFVM.TransType;
            vm.TransactionType = tType;
            return View("~/Areas/BWWF/Views/PreDistributionFund/IndexForfeitureAccount.cshtml",vm);
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/BWWF/Views/PreDistributionFund/Report.cshtml");
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptPreDistributionFund.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/BWWF/Views/PreDistributionFund/reportVeiw.cshtml", vm);
