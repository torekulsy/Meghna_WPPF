...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class TransactionMediaController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/BWWF/Views/TransactionMedia/Index.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return PartialView("~/Areas/BWWF/Views/TransactionMedia/Create.cshtml", vm);
        }
