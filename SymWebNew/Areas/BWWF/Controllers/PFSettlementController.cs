...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class PFSettlementController : Controller
    {
        ...
        /// Retrieves all BWWF Settlement information.
        /// </summary>      
        /// <returns>View containing BWWF Settlement</returns>
        ...
        /// Created: 13 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Handles the creation and updating of BWWF Settlement records based on the provided view model.
        /// </summary>
        ...
        /// Created: 13 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Loads a BWWF Settlement record and its associated details for editing based on the provided ID.
        /// </summary>
        /// <param name="id">The ID of the BWWF Settlement record to be edited.</param>
        /// <returns>
        ...
        /// - Retrieves the main BWWF settlement record and its detail records from the repository.  
        ...
        /// Created: 13 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Posts one or more BWWF Settlemant records based on the provided IDs.  
        /// Updates the session permission and invokes the repository post method.
        /// </summary>
        /// <param name="ids">Tilde (~) separated string of BWWF Settlemant fund IDs to post</param>
        /// <returns>
        ...
        /// Created: 13 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Retrieves a BWWF Settlement record by its ID and returns it as JSON.
        /// </summary>
        /// <param name="id">The ID of the BWWF Settlement record to retrieve.</param>
        /// <returns>
        /// A JsonResult containing the BWWF Settlement data.
        /// </returns>
        /// <remarks>
        /// - Sets the edit permission for the current user session.  
        /// - Retrieves the BWWF settlement data from the repository using the given ID.  
        /// - Used typically for AJAX calls to fetch BWWF settlement details dynamically.
        /// </remarks>
        [Authorize(Roles = "Admin")]
        ...
        /// Created: 13 Apr 2025  
        /// Created By: Md Torekul Islam  
        /// Generates and returns a PDF report for a specific BWWF Settlement record.
        /// </summary>
        /// <param name="Id">The ID of the BWWF Settlement record to generate the report for.</param>
        /// <returns>
        /// A PDF file rendered as an ActionResult containing the BWWF Settlement report.
        /// </returns>
        /// <remarks>
        /// - Loads data for the specified BWWF Settlement using the repository.  
        ...
        public ActionResult ReportView(string Id)
        {
            try
            {
                ...
                ReportHead = "There are no data to Preview for BWWF Settlement";
                if (table.Rows.Count > 0)
                {
                    ReportHead = "BWWF Settlement Statement";
                }
                ds.Tables.Add(table);
                ds.Tables[0].TableName = "dtPFSettlement";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptPFSettlement.rpt";
        ...
        public ActionResult JournalEntry(string Code)
        {
            ...
            return View("~/Areas/BWWF/Views/PFSettlement/Index.cshtml");
        }
