...
namespace SymWebUI.Areas.BWWF.Controllers
{
    public class BankChargeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/BWWF/Views/BankCharge/Index.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/BWWF/Views/BankCharge/Create.cshtml", vm);
        }
        [Authorize(Roles = "Admin")]
        [HttpPost]
        ...
        public ActionResult Detail(string id)
        {
            ...
            vm.TransType = AreaTypePFVM.TransType;
            vm = _repo.SelectAll(Convert.ToInt32(id)).FirstOrDefault();
            return View("~/Areas/BWWF/Views/BankCharge/Detail.cshtml", vm);
        }
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/BWWF/Views/BankCharge/Report.cshtml");
        }
        //[HttpGet]
        ...
        //        rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\BWWF\\rptBankCharge.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                return PartialView("~/Areas/BWWF/Views/BankCharge/reportVeiw.cshtml", vm);
