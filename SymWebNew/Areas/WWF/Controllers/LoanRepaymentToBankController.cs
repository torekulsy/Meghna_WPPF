...
namespace SymWebUI.Areas.WWF.Controllers
{
    public class LoanRepaymentToBankController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WWF/Views/LoanRepaymentToBank/Index.cshtml",vm);
        ...
        public ActionResult Create()
        {
            ...
            vm.TransType = AreaTypePFVM.TransType;
            vm.Operation = "add";
            return View("~/Areas/WWF/Views/LoanRepaymentToBank/Create.cshtml",vm);
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                dt.TableName = "dtLoan";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WWF\\rptLoanRepaymentToBank.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/WWF/Views/LoanRepaymentToBank/reportVeiw.cshtml", vm);
            }
            catch (Exception)
            {
                throw;
