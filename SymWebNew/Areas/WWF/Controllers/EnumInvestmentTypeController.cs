...
namespace SymWebUI.Areas.WWF.Controllers
{
    public class EnumInvestmentTypeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WWF/Views/EnumInvestmentType/Index.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return PartialView("~/Areas/WWF/Views/EnumInvestmentType/Create.cshtml", vm);
        }
