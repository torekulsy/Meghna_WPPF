...
namespace SymWebUI.Areas.WWF.Controllers
{
    public class LoanController1 : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WWF/Views/Loan/Index.cshtml",vm);
        }
        ...
        public ActionResult Create()
        {
            ...
            return View("~/Areas/WWF/Views/Loan/Create.cshtml" ,vm);
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WWF\\rptLoan.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.Code = Loanvm.Code;
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView( "~/Areas/WWF/Views/Loan/reportVeiw.cshtml", vm);
            }
            catch (Exception)
            {
                throw;
