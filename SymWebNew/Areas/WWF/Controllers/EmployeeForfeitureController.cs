...
namespace SymWebUI.Areas.WWF.Controllers
{
    public class EmployeeForfeitureController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WWF/Views/EmployeeForfeiture/Index.cshtml");
        }
        ...
        public ActionResult SingleEmployeeForfeitureEdit(string PFOpeinigId, string Operation = "")
        {
           ...
           // vm.empPFForfeitureVM = empForfeitureVM;
            ...
            return View("~/Areas/WWF/Views/EmployeeForfeiture/SingleEmployeeForfeitureEdit.cshtml", vm);
        }
        ...
        public ActionResult Create(EmployeeInfoVM empVM)
        {
            ...
            try
            {
               ...
               // vm = empVM.empPFForfeitureVM;
                ...
                ////return Redirect("/WWF/EmployeeForfeiture/SingleEmployeeForfeitureEdit?PFOpeinigId=" + result[2].ToString());
        ...
        public ActionResult ImportEmployeeForfeiture()
        {
            ...
            return View("~/Areas/WWF/Views/EmployeeForfeiture/ImportEmployeeForfeiture.cshtml");
        }
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
               ...
               // EmployeePFForfeitureVM = _eaRepo.SelectById(id.ToString());
                ...
                vm.Id = id;
                vm.Code = data.Code;
                return PartialView("~/Areas/WWF/Views/EmployeeForfeiture/reportVeiw.cshtml", vm);
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WWF\\rptPFEmployeeForfeiture.rpt";
