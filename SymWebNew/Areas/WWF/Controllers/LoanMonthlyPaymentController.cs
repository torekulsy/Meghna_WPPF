...
namespace SymWebUI.Areas.WWF.Controllers
{
    public class LoanMonthlyPaymentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WWF/Views/LoanMonthlyPayment/Index.cshtml",vm);
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/WWF/Views/LoanMonthlyPayment/Create.cshtml", vm);
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                dt.TableName = "dtLoan";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WWF\\rptLoanMonthlyPayment.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/WWF/Views/LoanMonthlyPayment/reportVeiw.cshtml", vm);
