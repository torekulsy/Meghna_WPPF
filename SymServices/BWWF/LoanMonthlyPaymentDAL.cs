...
namespace SymServices.BWWF
{
    public class LoanMonthlyPaymentDAL
    {
        ...
        //==================SelectAll=================
        /// <summary>
        /// Retrieves a list of BWWF Loan Monthly Payment from the database, optionally filtered by ID or additional conditions.
        /// Supports external SQL connection and transaction handling for reuse within larger operations.
        /// </summary>
        /// <param name="Id">Optional ID to filter a specific BWWF Loan Monthly Payment.</param>
        ...
        /// <returns>A list of <see cref="BankBranchVM"/> representing the BWWF Loan Monthly Payment matching the criteria.</returns>
...
";
        ...
        //==================Insert =================
        // <summary>
        /// Inserts a new BWWF Loan Monthly Paymen record into the database with the provided details from the view model.
        /// Handles optional SQL connection and transaction management for use in broader transactional operations.
        /// </summary>
        /// <param name="vm">The <see cref="BankBranchVM"/> containing the BWWF Loan Monthly Paymen data to insert.</param>
...
";
                    ...
                    cmdInsert.Parameters.AddWithValue("@TransType", vm.TransType ?? "BWWF");
        ...
        //==================Update =================
        /// <summary>
        /// Updates an existing BWWF Loan record Monthly Paymen in the database with values from the provided view model.
        /// Handles optional SQL connection and transaction to allow for usage in broader transaction scopes.
        /// </summary>
        /// <param name="vm">The <see cref="BankBranchVM"/> containing the updated BWWF Loan Monthly Paymen information.</param>
        ...
        public string[] Update(LoanMonthlyPaymentVM vm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            ...
            try
            {
                ...
                if (vm != null)
                {
                    ...
                    cmdUpdate.Parameters.AddWithValue("@TransType", vm.TransType ?? "BWWF");
