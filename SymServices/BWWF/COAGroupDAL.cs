...
namespace SymServices.BWWF
{
    public class COAGroupDAL
    {
        ...
        /// </summary>
        /// <param name="TransType">The transaction type to filter COA records by (e.g., "BWWF"). Defaults to "BWWF".</param>
        /// <returns>
        ...
        /// </exception>
        public List<COAGroupVM> DropDown(string TransType="BWWF")
        {
            #region Variables
...
";
        ...
        /// Thrown when a SQL or general exception occurs during data retrieval, including the SQL query in the message.
        /// </exception>
        public List<COAGroupVM> COATypeOfReportDropDown(string TransType = "BWWF")
        {
            #region Variables
            SqlConnection currConn = null;
            string sqlText = "";
...
";
        ...
        /// Thrown when a SQL or general exception occurs during data retrieval, including the SQL query in the message.
        /// </exception>
        public List<COAGroupVM> COAGroupTypeDropDown(string TransType = "BWWF")
        {
            #region Variables
            SqlConnection currConn = null;
            string sqlText = "";
