...
namespace SymServices.BWWF
{
    public class BankNameDAL
    {
        ...
        //==================DropDown=================
        /// <summary>
        /// Retrieves the Provident Fund (BWWF) balance and applicable interest rates for a specific employee
        /// as of the provided application date.
        /// </summary>
        /// <param name="ApplicationDate">The date for which the BWWF balance is to be calculated. If null or empty, the current date is used.</param>
        /// <param name="emploanId">The unique identifier of the employee's loan record.</param>
        /// <returns>
        /// A JSON result containing the BWWF balance, available rate, interest rates for different durations,
...
";
                    ...
                    cmdInsert.Parameters.AddWithValue("@BranchId", vm.BranchId ?? "BWWF");
