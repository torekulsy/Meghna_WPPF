...
namespace SymServices.WWF
{
    public class BankNameDAL
    {
        ...
        //==================DropDown=================
        /// <summary>
        /// Retrieves the Provident Fund (WWF) balance and applicable interest rates for a specific employee
        /// as of the provided application date.
        /// </summary>
        /// <param name="ApplicationDate">The date for which the WWF balance is to be calculated. If null or empty, the current date is used.</param>
        /// <param name="emploanId">The unique identifier of the employee's loan record.</param>
        /// <returns>
        /// A JSON result containing the WWF balance, available rate, interest rates for different durations,
        /// and a flag indicating whether the rates are sourced from settings.
        /// </returns>
        public List<BankNameVM> DropDown(string TransType="WWF",string BranchId="")
        {
            #region Variables
...
";
                    ...
                    cmdInsert.Parameters.AddWithValue("@BranchId", vm.BranchId ?? "WWF");
