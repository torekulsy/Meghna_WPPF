...
";
        ...
        public ResultVM Process(ProfitDistributionNewVM vm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            ...
            try
            {
                ...
                string IsWeightedAverageMonth = _settingDal.settingValue("WWF", "IsWeightedAverageMonth").Trim();
...
";
                ...
                string IsProfitCalculation = _settingDal.settingValue("WWF", "IsProfitCalculation").Trim();
