...
";
        ...
        public DataTable EmployeeLoanSettelment(string rType, string ToDate, string FromDate, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
...
SELECT ve.Code,ve.EmpName,
  ...
  FROM [EmployeeLoan] el 
  Left Outer Join [ViewEmployeeInformation] ve on ve.EmployeeId=el.EmployeeId
  where IsEarlySellte=1 and  EarlySellteDate between CONVERT(DATETIME, @DateFrom, 112) and CONVERT(DATETIME, @ToDate, 112) 
";
                #endregion
